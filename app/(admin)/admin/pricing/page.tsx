    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      {canEdit && (
        <div className="mb-6 rounded-xl border border-stone-200 bg-white p-6">
          ...
          <p className="mt-1 text-sm text-stone-500 mb-4">Automatic % off per LINE on trade-portal orders when a dealer buys in bulk — e.g. 12+ pcs <Icon g="→" className="inline-block align-middle w-[1em] h-[1em]" />5%, 50+ <Icon g="→" className="inline-block align-middle w-[1em] h-[1em]" />10%. Applied server-side at billing; the invoice shows the discount per line. Leave rows blank to disable.</p>
            ...
            {[1, 2, 3].map((i) => {
              ...
              return (
                <div key={i} className="flex items-center gap-3 text-[15px]">
                  ...
                  <span className="text-stone-500">pcs <Icon g="→" className="inline-block align-middle w-[1em] h-[1em]" /></span>
