  ...
  return (
    <main className="min-h-screen bg-ivory grid place-items-center p-5">
      <div className="w-full max-w-lg bg-white rounded-3xl shadow-luxe p-7">
        ...
        <p className="text-sm text-muted mt-1 mb-5">Your feedback helps us serve you better — it takes 20 seconds <Icon g="💛" className="inline-block align-middle w-[1em] h-[1em]" /></p>
