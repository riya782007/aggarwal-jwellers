...
export async function draftReviewReplyAction(reviewId: string): Promise<{ ok: boolean; reply: string }> {
  ...
  const system = `You write warm, gracious, concise public replies (max 2 sentences) on behalf of "Aggarwal Jewellers", a premium artificial-jewellery brand. Thank the customer by first name, be specific to their words, and stay brand-appropriate. For low ratings, apologise sincerely and invite them to WhatsApp +91 98731 51767. No hashtags, at most one emoji.`;
