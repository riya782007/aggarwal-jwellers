...
export const PAGES: Record<string, Page> = {
  about: {
    ...
    intro: "Bridal, AD, anti-tarnish & daily-wear jewellery from the heart of Sadar Bazar, Delhi.",
    sections: [
      { h: "Our story", p: "Aggarwal Jewellers began in the bustling lanes of Rui Mandi, Sadar Bazar — one of India's largest jewellery wholesale hubs. What started as a family trade has grown into a house trusted by retailers across the country and loved by thousands of customers." },
      { h: "Our craft", p: "We make every kind of bridal jewellery, AD (American Diamond) pieces, anti-tarnish and daily-wear designs — traditional artistry like Kundan, Meenakari, Temple and Polki alongside modern, trend-ready styles. Premium brass alloys with anti-tarnish plating keep your jewellery beautiful, lightweight and comfortable for daily and festive wear." },
  ...
  contact: {
    ...
    sections: [
      { h: "WhatsApp & Orders", p: "Message us on WhatsApp at +91 11 4004 7222 for orders, stock checks, and wholesale enquiries — it's the fastest way to reach us." },
      { h: "Call & Email", p: "Phone: +91 83750 23077, Monday to Saturday, 10:00 AM – 8:00 PM IST · Email: aggarwaljewellers5005@gmail.com" },
      { h: "Visit", p: "Aggarwal Jewellers · 5005, Rui Mandi, Sadar Bazar, Delhi - 110006, India." },
