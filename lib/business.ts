 ...
 *
 * Bank account / IFSC are read from env (AGGARWAL_BANK_ACCOUNT, AGGARWAL_BANK_IFSC) so the
...
export const BUSINESS = {
  ...
  bank: {
    name: process.env.AGGARWAL_BANK_NAME || "Kotak Mahindra Bank",
    account: process.env.AGGARWAL_BANK_ACCOUNT || "", // configured via env
    ifsc: process.env.AGGARWAL_BANK_IFSC || "",       // configured via env
    branch: process.env.AGGARWAL_BANK_BRANCH || "Delhi",
  },
  terms: [
