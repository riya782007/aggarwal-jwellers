...
const STR = {
  ...
  showingWord: { en: "Showing", hi: "दिखा रहे हैं" },
  liveFromCatalog: {
    en: "live from your catalogue & orders",
    hi: "आपके कैटलॉग और ऑर्डर से लाइव",
  },
  inRevenue: { en: "in revenue", hi: "आमदनी" },
  ordersSmall: { en: "orders", hi: "ऑर्डर" },
  salesByChannel: { en: "Sales by channel", hi: "चैनल के हिसाब से बिक्री" },
  tapCardExpand: {
    en: "tap any card to expand the full report for",
    hi: "पूरी रिपोर्ट के लिए कोई भी कार्ड दबाएँ —",
  },
  ...
  partiesTap: {
    en: "parties · tap for the list",
    hi: "पार्टियाँ · सूची देखें",
  },
  ...
  walkInNote: {
    en: "Walk-in bills — receive from the invoice page",
    hi: "वॉक-इन बिल — इनवॉइस पेज से दर्ज करें",
  },
  noDues: {
    en: "No outstanding balances — everyone is settled.",
    hi: "कोई बाकी नहीं — सबका हिसाब चुकता।",
  },
  ...
  qaTakePhoto: {
    en: "Tap to take / choose a photo",
    hi: "फ़ोटो खींचें या चुनें",
  },
  ...
  qaVoiceHint: {
    en: 'e.g. "gold jhumka, 50 pieces, cost 80"— fills the form for you',
    hi: 'जैसे "गोल्ड झुमका, 50 पीस, लागत 80"— फ़ॉर्म अपने-आप भर जाएगा',
  },
  ...
  qaSaving: {
    en: "Adding… the AI is writing the listing from your photo",
    hi: "जोड़ रही हूँ… AI फ़ोटो से लिस्टिंग लिख रहा है",
  },
  qaDone: { en: "Added as a draft", hi: "ड्राफ़्ट में जुड़ गया" },
  qaDoneNote: {
    en: "Name, description, SKU and prices were drafted automatically — review & publish from the Catalogue.",
    hi: "नाम, विवरण, SKU और दाम अपने-आप बन गए — कैटलॉग से देखकर पब्लिश करें।",
  },
  ...
  privacyHiddenMsg: {
    en: "Screen hidden for privacy",
    hi: "गोपनीयता के लिए स्क्रीन छिपी है",
  },
