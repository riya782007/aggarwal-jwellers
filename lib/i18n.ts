...
const STR = {
  ...
  liveFromCatalog: { en: "live from your catalogue & orders", hi: "आपके कैटलॉग और ऑर्डर से लाइव" },
  ...
  tapCardExpand: { en: "tap any card to expand the full report for", hi: "पूरी रिपोर्ट के लिए कोई भी कार्ड दबाएँ —" },
